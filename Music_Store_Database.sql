...
FROM track
WHERE miliseconds > (SELECT AVG(miliseconds) AS avg_track_length FROM track)
...
/* Steps to Solve:  There are two parts in question- first, the most popular music genre, and second, the need for data at the country level. */
